...
float x = 0, y = 0;
int sc=0,dc=0;
float m[GRAPHSIZE][GRAPHSIZE] = {{0, 1.33, 0.56, -1.33, -0.55}, {1.33, 0, 0, -10.6, -1.76}, {0.56, -0.25, 0, 1.76, -10.6},
{-1.33, -10.6, 1.76, 0, 0}, {-0.55, -1.76, -10.6, 0.15, 0}};
...
void submenu2(int id){
    std::cout<<"Dest MEnu entered"<<std::endl;
    if(flag>=1){
